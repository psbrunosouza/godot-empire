...
const castle_scene: PackedScene = preload("res://entities/castle/castle.tscn")
const spot_scene: PackedScene = preload("res://entities/spots/spot.tscn")
const card_scene: PackedScene = preload("res://entities/characters/card.tscn")
...
func draw_character() -> CharacterCard:
	var resource = GameManager.card_resources.keys().pick_random()
	var card = create_card(resource)
