...
var projectile_scene: PackedScene =  load("res://entities/projectiles/projectile.tscn")
...
func attack(enemy: Enemy):
	...
	var target_angle = projectile.get_angle_to(enemy.global_position) * (180/3.14)
